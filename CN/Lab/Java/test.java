...
public class test {
  ...
  public static void main(String argv[]) throws Exception {
    String user = "s2010876144@ru.ac.bd";
    String pass = "rucse2010";
    
    String username =new String(Base64.getEncoder().encode(user.getBytes()));
    String password = new String(Base64.getEncoder().encode(pass.getBytes())); //pass;//
    ...
    send("MAIL FROM:<s2010876144@ru.ac.bd>\r\n");
              System.out.println("SERVER: "+ br.readLine());
    ...
    send("FROM: s2010876144@ru.ac.bd\r\n");
